...
<head>
    ...
    <style>
        ...
        .overlay { display: none; /* Hidden by default */ position: fixed; width: 100%; height: 100%; top: 0; left: 0; background-color: rgba(0, 0, 0, 0.7); z-index: 1000; display: flex; /* Use flex for centering */ justify-content: center; align-items: center; backdrop-filter: blur(3px); }
        ...
        .confirmation-modal { display: none; /* Hidden */ position: fixed; z-index: 1100; left: 0; top: 0; width: 100%; height: 100%; background-color: rgba(0, 0, 0, 0.6); overflow: hidden; display: flex; align-items: center; justify-content: center; }
