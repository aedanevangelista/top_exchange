...
<body>
    ...
    <script src="/js/toast.js"></script>
        ...
        // --- Deliveries Modal Logic (IMPLEMENTATION INCLUDED) ---
        ...
        // --- Client-Side Validation Functions (IMPLEMENTATION INCLUDED) ---
        function validateContactNumber(contactInput, errorElement) {
            ...
            else if (!pattern.test(contactValue)) { $(errorElement).text('Must be only digits (up to 12).'); $(contactInput).addClass('form-field-error'); return false; }
            else if (contactValue.length < 4 && $(contactInput).closest('form').attr('id') === 'addDriverForm') { $(errorElement).text('Must be at least 4 digits long.'); $(contactInput).addClass('form-field-error'); return false; }
