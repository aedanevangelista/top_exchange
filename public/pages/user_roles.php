...
<body>
    ...
    <div id="addRoleOverlay" class="overlay" style="display: none;">
        <div class="overlay-content">
            <h2><i class="fas fa-user-plus"></i> Add Role</h2>
            <div id="addAccountError" class="error-prompt"></div>
            <form id="addRoleForm" method="POST" class="account-form">
                ...
                <div class="form-buttons">
                    ...
                    <button type="button" class="cancel-btn" onclick="closeAddRoleForm()">
    ...
    <!-- Overlay Form for Editing Role -->
    <div id="editRoleOverlay" class="overlay" style="display: none;">
        <div class="overlay-content">
            <h2><i class="fas fa-user-edit"></i> Edit Role</h2>
            <div id="editAccountError" class="error-prompt"></div>
            <form id="editRoleForm" method="POST" class="account-form">
                <input type="hidden" id="editRoleId" name="role_id">
                <label for="editRoleName">Role Name:</label>
                <input type="text" id="editRoleName" name="role_name" required>
                <br/>
                <label>Select Pages:</label>
                <div id="editPagesCheckboxes" class="checkbox-group">
                    <?php 
                    // Reset the result pointer and fetch pages again for edit form
                    $pages->data_seek(0); 
                    while ($page = $pages->fetch_assoc()): ?>
                        <div class="checkbox-container">
                            <input type="checkbox" id="edit_page_<?= $page['page_id'] ?>" name="page_ids[]" value="<?= $page['page_id'] ?>">
                            <label for="edit_page_<?= $page['page_id'] ?>"><?= htmlspecialchars($page['page_name']) ?></label>
                        </div>
                    <?php endwhile; ?>
                </div>
                <div class="form-buttons">
                    <button type="submit" class="save-btn"><i class="fas fa-save"></i> Save</button>
                    <button type="button" class="cancel-btn" onclick="closeEditRoleForm()">
                        <i class="fas fa-times"></i> Cancel
                    </button>
                </div>
            </form>
